...
if __name__ == "__main__":
    ...
    parameters = {'class_weight': [{0:0.7, 1:0.3}, {0:0.6, 1:0.4}, {0:0.5, 1:0.5}, {0:0.4, 1:0.6}, {0:0.3, 1:0.7}], 'max_depth':[3, 5, 7, 9]}
    model = TimeSeriesForest(random_state = 7)
    train(classifier = model, parameters = parameters, threshold = 500)